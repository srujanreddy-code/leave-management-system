...
/**
 * Integration tests for {@link DepartmentServiceImpl}.
 *
 * <p>
 * These tests load the Spring application context and use the actual
 * repository and test database to verify department service behavior.
 * </p>
 */
@SpringBootTest
@ActiveProfiles("test")
...
class DepartmentServiceImplIntegrationTest {
    ...
    /**
     * Clears department records before each test.
     */
    @BeforeEach
    void setUp() {
    ...
    /**
     * Verifies that duplicate names are rejected regardless of case.
     */
    @Test
    ...
    /**
     * Verifies that an unknown department ID throws
    ...
    /**
     * Verifies that getAll returns only non-deleted departments.
     */
    @Test
    ...
    /**
     * Verifies that updating a department with an existing name
